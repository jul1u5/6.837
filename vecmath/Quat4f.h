...
class Quat4f {
  public:
    ...
    // squadTangent)
    static Quat4f squad(const Quat4f &a, const Quat4f &tanA, const Quat4f &tanB,
                        const Quat4f &b, float t);

    static Quat4f cubicInterpolate(const Quat4f &q0, const Quat4f &q1,
    ...
    static Quat4f fromRotatedBasis(const Vector3f &x, const Vector3f &y,
                                   const Vector3f &z);
